...
import layers2 as layers
from sync_batchnorm2 import SynchronizedBatchNorm2d as SyncBatchNorm2d
...
def G_arch(ch=64, attention='64', ksize='333333', dilation='111111'):
  ...
  arch[360] = {'in_channels' :  [ch*item for item in [16, 8, 8, 4, 4, 2, 1, 1]],
               'out_channels' : [item * ch for item in [8, 8, 4, 4, 2, 1]],
               'upsample' : [True] * 7,
               'resolution' : [6 , 12, 24, 48, 96, 192, 360],
                'attention' : {45:45}}
...
class Generator(nn.Module):
  def __init__(self, G_ch=64, G_depth=2, dim_z=128, bottom_width=6, resolution=360,
    ...
    for index in range(len(self.arch['out_channels'])):
      ...
      if self.arch['resolution'][index] == 48:
...
class Discriminator(nn.Module):
  ...
  def __init__(self, D_ch=64, D_wide=True, D_depth=2, resolution=360,
               ...
               SN_eps=1e-12, output_dim=1, D_mixed_precision=False,
